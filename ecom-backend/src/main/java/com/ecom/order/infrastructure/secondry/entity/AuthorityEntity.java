...
import com.ecom.order.domain.user.aggregate.Authority;
import com.ecom.order.domain.user.aggregate.AuthorityBuilder;
...
public class AuthorityEntity implements Serializable {
    ...
    // mapping forse preferisco DTO SEMPLICI che Jilt
